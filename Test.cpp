 ...
 * Date: 11/4/2021
 * Description: This is the running program for Assignment 3. It has various test
 * functions that are called to test the maximum values that are in a stack after
 * various operations are calculated. The mean value, which is also known as the * * ffaverage caluation on the stack.
 * The output passes 33/40  tests overall.
 *
 * TILE: Extentions of Linked Based Stack
 * In this assignment, you will extend the link-based implementation of Stack. This Stack will support 3 more additional functions:
 *
 * 1. T max() const;
 ...
 * helper functions. You don’t need to use any data structure or algorithms that we haven’t covered in class.
 */
